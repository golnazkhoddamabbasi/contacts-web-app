...
import { CYAN, ORANGE, PINK, RED } from "../color"
const Contact=({contact , alert})=>{
    return(
    
    <>
    <div className="col-md-6">
        <div style={{backgroundColor:PINK}} className="card my-2">
            <div className="card-body">
                <div className="row align-items-center d-flex justify-content-around">
                    ...
                    <div className="col-md-1 col-sm-1 d-flex flex-column align-items-center">
                        ...
                        <button onClick={alert} className="btn my-1" style={{backgroundColor:RED}}> 
